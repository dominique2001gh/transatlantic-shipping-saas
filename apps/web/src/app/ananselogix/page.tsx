    ...
    <>
      ...
      <section className="py-20 lg:py-24">
        <Container>
          ...
          <div className="mt-10 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-center">
            <PhotoPlaceholder icon={IconLayers} label="Owner dashboard — shipments, revenue, and exceptions at a glance" aspect="aspect-[16/10]" />
          ...
          <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-5">
            {workflowSteps.map((step, index) => (
              <div key={step.label} className="rounded-xl border border-slate-200 bg-white p-4 text-center">
                <span className="mx-auto flex h-8 w-8 items-center justify-center rounded-full bg-primary-700 text-sm font-semibold text-white">
                  {index + 1}
                </span>
      ...
      <section className="py-20 lg:py-24">
        <Container className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
          ...
          <PhotoPlaceholder icon={IconHeadset} label="AI Training & Support Agent chat" tone="teal" aspect="aspect-[4/3]" />
        </Container>
      </section>
